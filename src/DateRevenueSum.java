...
public class DateRevenueSum extends Configured implements Tool {
  ...
  public static class DateRevenueMapper
...
// regex for capturing exactly 6 dollar amounts with commas as we expect in the input file
  ...
  public static class DateRevenueReducer
  ...
  public int run(String[] args) throws Exception {
    ...
    job.setJarByClass(DateRevenueSum.class);
    job.setMapperClass(DateRevenueMapper.class);
    job.setCombinerClass(DateRevenueReducer.class);
    job.setReducerClass(DateRevenueReducer.class);
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new DateRevenueSum(), args);
    System.exit(res);
  }
